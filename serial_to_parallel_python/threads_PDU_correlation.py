...
#       print(str(PDU_ID)+" "+str(outlet_index))
      if (outlet_index==5 and PDU_ID==0):
        value = max_power
      else:
        value=random.randrange(0,max_power,1) # instantaneous power for the outlet in Watts
...
#   print(newdic)
#   len(output) returns number of key value pairs

  average_power_dic = {}
  for key in full_results_dic:
#     print(key)
#     print(newdic[key])
    power_ary=full_results_dic[key]
...
#     print (w+": "+str(average_power_dic[w]))
